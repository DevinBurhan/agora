...
export function createMicrophoneAndCameraTracks(
  ...
  async function createClosure() {
    tracks = await AgoraRTC.createMicrophoneAndCameraTracks(audioConfig, videoConfig);
    return tracks;
  }
 ...
 * @category Wrapper
 */
export function createBufferSourceAudioTrack(config: BufferSourceAudioTrackInitConfig) {
 ...
 * @category Wrapper
 */
export function createMicrophoneAudioTrack(config?: MicrophoneAudioTrackInitConfig) {
