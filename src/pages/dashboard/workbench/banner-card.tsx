...
export default function BannerCard() {
  const { firstName, lastName, organisationId } = useUserInfo();
  ...
  return (
    ...
    >
      <Col span={24} md={12} xl={16} className="flex-1 text-center md:text-left">
        ...
        >
          Welcome to join Head Gear Admin.
          <div>
            <button
              className="text-base opacity-80"
              style={{ color: themeToken.colorPrimaryTextActive }}
            >
              👉 https://head-gear-streaming-page.com
            </button>
          </div>
        </div>
        <button
        ...
        >
          <Iconify icon="mage:playstore" size={24} />
          <span className="ml-2 font-black">Join Us</span>
        </button>
      </Col>
