...
function Login() {
  ...
  return (
    <Layout className="relative flex !min-h-screen !w-full !flex-row">
      <div
        className="hidden grow flex-col items-center justify-center gap-[40px] bg-center bg-no-repeat sm:flex"
        style={{
          background: bg,
        }}
      >
        <div className="flex flex-col items-center justify-center gap-[10px]">
          {/* {themeMode === 'dark' ? (
            <img src={lightLogo} alt="head-gear-and-streaming" width={70} height={70} />
          ) : (
            <img src={darkLogo} alt="head-gear-and-streaming" width={70} height={70} />
          )} */}
      ...
      <div className="m-auto flex !h-screen w-full max-w-[600px] flex-col justify-center px-[16px] lg:px-[64px]">
        <LoginStateProvider>
          <LoginForm />
          <RegisterForm />
          <ForgotPass />
